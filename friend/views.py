...
def friends_list_view(request, *args, **kwargs) -> HttpResponse:
    context = {}
    user = request.user
    if user.is_authenticated:
        ...
        if user_id:
            ...
            friends: list[tuple[User, bool]] = []  # [(friend1, True), (friend2, False), ...]
...
def friend_requests(request, *args, **kwargs) -> HttpResponse:
    context = {}
    user = request.user
    if user.is_authenticated:
        user_id = kwargs.get("user_id")
